/*Game_Engine jest plikiem, który łączy większość zasad oraz elementów gry w pokera
* Gra zostaje uruchomiona, gracze otrzymują karty i są pytani o ich udział w licytacji
*/
